...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="../assurances/index.php" class="nav-link active"><span class="nav-icon">🛡️</span> Assurances</a>
...
$title='Assurances';
?>
<div class="admin-card" style="padding:2rem;text-align:center;color:var(--gray400)">
  <div style="font-size:2rem;margin-bottom:1rem">🚧</div>
  <div style="font-family:Sora,sans-serif;font-weight:700;font-size:1rem;color:#1e293b;margin-bottom:.5rem">Assurances</div>
  <p style="font-size:.85rem">Module en cours de développement. Les données sont disponibles en base.</p>
</div>
