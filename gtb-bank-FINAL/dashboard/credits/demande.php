...
.modal-overlay{position:fixed;inset:0;background:rgba(5,11,20,.65);backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;z-index:600;opacity:0;visibility:hidden;transition:.3s;padding:1rem}.modal-overlay.open{opacity:1;visibility:visible}.modal-box{background:#fff;border-radius:var(--r-xl);width:100%;max-width:520px;max-height:90vh;overflow-y:auto;box-shadow:0 40px 100px rgba(13,27,42,.2);transform:scale(.95) translateY(20px);transition:.35s var(--bounce)}.modal-overlay.open .modal-box{transform:none}.modal-head{padding:1.4rem 1.5rem 0;display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem}.modal-title{font-family:'Sora',sans-serif;font-weight:700;font-size:.98rem;color:var(--bnp-dark)}.modal-close{width:32px;height:32px;border-radius:50%;background:var(--gray50);border:1px solid var(--gray100);cursor:pointer;font-size:.95rem;color:var(--gray600);display:flex;align-items:center;justify-content:center;transition:.2s}.modal-close:hover{background:var(--gray100)}.modal-body{padding:0 1.5rem 1.25rem}.modal-foot{padding:.25rem 1.5rem 1.5rem;display:flex;gap:.5rem}.modal-foot .btn{flex:1}.form-group{margin-bottom:.85rem}.form-label{display:block;font-size:.68rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:var(--gray600);margin-bottom:.35rem}.form-input,.form-select,.form-textarea{width:100%;padding:.7rem 1rem;font-family:'DM Sans',sans-serif;font-size:.84rem;color:var(--gray800);background:var(--gray50);border:1.5px solid var(--gray100);border-radius:var(--r-md);outline:none;transition:.2s}.form-input:focus,.form-select:focus,.form-textarea:focus{border-color:var(--bnp-emerald);background:#fff;box-shadow:0 0 0 3px rgba(212,175,55,.12)}.form-textarea{resize:vertical;min-height:90px}.form-hint{font-size:.7rem;color:var(--gray400);margin-top:.2rem}.form-row{display:grid;grid-template-columns:1fr 1fr;gap:.75rem}.tbl-wrap{overflow-x:auto;border-radius:var(--r-lg);border:1px solid var(--gray100)}.tbl{width:100%;border-collapse:collapse;min-width:540px}.tbl thead th{padding:.65rem 1rem;font-size:.63rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--gray400);text-align:left;background:var(--gray50);border-bottom:1.5px solid var(--gray100);white-space:nowrap}.tbl tbody td{padding:.82rem 1rem;font-size:.82rem;color:var(--gray800);border-bottom:1px solid var(--gray50)}.tbl tbody tr{transition:background .15s}.tbl tbody tr:hover{background:rgba(212,175,55,.03)}.tbl tbody tr:last-child td{border-bottom:none}.chips{display:flex;gap:.4rem;flex-wrap:wrap}.chip{padding:.36rem .82rem;border-radius:999px;font-size:.74rem;font-weight:600;cursor:pointer;background:#fff;border:1.5px solid var(--gray100);color:var(--gray600);transition:.2s}.chip.active{background:var(--bnp-dark);border-color:var(--bnp-dark);color:#fff}.sec-head{display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:1.5rem;gap:1rem;flex-wrap:wrap}.pg-title{font-family:'Sora',sans-serif;font-weight:800;font-size:clamp(1.1rem,2.5vw,1.4rem);color:var(--bnp-dark)}.pg-sub{font-size:.82rem;color:var(--gray400);margin-top:.3rem}.row-item{display:flex;align-items:center;gap:.85rem;padding:.85rem 0;border-bottom:1px solid var(--gray50)}.row-item:last-child{border-bottom:none}.row-icon{width:42px;height:42px;border-radius:var(--r-md);display:flex;align-items:center;justify-content:center;font-size:1.1rem;flex-shrink:0}.row-info{flex:1;min-width:0}.row-title{font-size:.85rem;font-weight:600;color:var(--bnp-dark)}.row-sub{font-size:.72rem;color:var(--gray400);margin-top:.12rem}.step-row{display:flex;align-items:center;gap:0;margin-bottom:2rem}.step-num{width:32px;height:32px;border-radius:50%;border:2px solid var(--gray200);display:flex;align-items:center;justify-content:center;font-family:'Sora',sans-serif;font-weight:700;font-size:.75rem;color:var(--gray400);transition:.3s;flex-shrink:0}.step-num.active{background:var(--bnp-emerald);border-color:var(--bnp-emerald);color:#fff}.step-num.done{background:var(--green);border-color:var(--green);color:#fff}.step-lbl{font-size:.75rem;font-weight:500;color:var(--gray400);margin-left:.4rem}.step-lbl.active{color:var(--bnp-dark);font-weight:700}.step-line{flex:1;height:2px;background:var(--gray100);margin:0 .5rem;transition:.3s}.step-line.done{background:var(--green)}.info-box{background:rgba(26,115,232,.06);border:1px solid rgba(26,115,232,.2);border-radius:var(--r-md);padding:.85rem 1rem;font-size:.8rem;color:var(--blue);line-height:1.55}@media(max-width:900px){.form-row{grid-template-columns:1fr}}</style><link rel="stylesheet" href="../mobile.css">
...
<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-user"><div class="sidebar-avatar"><?php echo $initials;?></div><div class="sidebar-user-info"><div class="sidebar-user-name"><?php echo e(($u['first_name']??'').' '.($u['last_name']??'')); ?></div></div></div>
  <nav class="sidebar-nav">
    ...
    <a href="../credits/index.php" class="sidebar-link active"><span class="sidebar-icon">◎</span> Crédits </a>
...
<header class="topbar" id="topbar"><div class="topbar-left"><button class="sidebar-toggle" id="sidebarToggle">☰</button><div><div class="topbar-page-title"><?php echo $title??''?></div><div class="topbar-breadcrumb"><?php echo $breadcrumb??''?></div></div></div><div class="topbar-right"><a href="../notifications.php" class="topbar-btn">🔔</a><div class="topbar-user" style="cursor:pointer" onclick="location.href='../profil/index.php'"><div class="topbar-user-av"><?php echo $initials;?></div><span class="topbar-user-name"><?php echo e($u['first_name']??'')?></span></div></div></header>
<main class="dash-main">
<?php
$title='Demande de crédit'; $breadcrumb='Crédits · Nouvelle demande';
$error=''; $success=''; $ref='';
if($_SERVER['REQUEST_METHOD']==='POST'&&Security::verifyCsrf($_POST['_csrf']??'')){
    $type=$_POST['type']??''; $montant=(float)($_POST['montant']??0);
    $duree=(int)($_POST['duree']??0); $revenus=(float)($_POST['revenus']??0);
    $charges=(float)($_POST['charges']??0);
    $rates=['immobilier'=>1.9,'auto'=>3.2,'travaux'=>3.8,'consommation'=>4.5,'professionnel'=>3.5];
    if(!$type||!isset($rates[$type])||$montant<1000||$duree<12||$revenus<=0){$error='Veuillez remplir tous les champs correctement.';}
    else{
        ...
        send_notification_email(Session::userId(),'Votre demande de crédit — GTB Bank',"Votre dossier crédit <strong>#$ref</strong> est ".($statut==='refuse'?'<span style=\"color:#dc2626\">refusé</span>':'en cours d\'étude. Vous recevrez une réponse sous 24h ouvrées').'.');
        ...
        $statut_label=$statut==='refuse'?'REFUSÉ (endettement '.$endettement.'%)':'EN ÉTUDE';
        $html_adm="<div style='font-family:Arial,sans-serif;max-width:520px;margin:auto;padding:32px;border:1px solid #e5e7eb;border-radius:8px'><h2 style='color:#1a3c5e'>Nouvelle demande de crédit</h2><table style='width:100%;border-collapse:collapse;color:#374151'><tr><td style='padding:6px 0;font-weight:600'>Client</td><td>{$u['prenom']} {$u['nom']} ({$u['email']})</td></tr><tr><td style='padding:6px 0;font-weight:600'>Référence</td><td>$ref</td></tr><tr><td style='padding:6px 0;font-weight:600'>Type</td><td>".strtoupper($type)."</td></tr><tr><td style='padding:6px 0;font-weight:600'>Montant</td><td>".format_money($montant)."</td></tr><tr><td style='padding:6px 0;font-weight:600'>Durée</td><td>$duree mois</td></tr><tr><td style='padding:6px 0;font-weight:600'>Mensualité</td><td>".format_money(round($mens,2))."</td></tr><tr><td style='padding:6px 0;font-weight:600'>Statut</td><td>$statut_label</td></tr><tr><td style='padding:6px 0;font-weight:600'>Date</td><td>".date('d/m/Y H:i')."</td></tr></table><a href='".GTB_BASE_URL."/admin/credits/index.php' style='display:inline-block;margin:20px 0;padding:12px 24px;background:#1a3c5e;color:#fff;text-decoration:none;border-radius:6px;font-weight:600'>Voir le dossier</a><p style='color:#9ca3af;font-size:12px'>Global Trust Bank — Notification automatique</p></div>";
        send_email(MAIL_SUPPORT,'Admin GTB',"Crédit $ref — {$u['prenom']} {$u['nom']} — $statut_label",$html_adm);
...
$csrf=csrf_token();
$rates_display=['immobilier'=>'1,9%','auto'=>'3,2%','travaux'=>'3,8%','consommation'=>'4,5%'];
?>
<div class="sec-head"><div><a href="index.php" style="font-size:.8rem;color:var(--gray400);text-decoration:none">← Retour aux crédits</a><h1 class="pg-title" style="margin-top:.4rem">Demande de crédit</h1></div></div>
<?php if($success):?>
<div style="background:<?php echo strpos($success,'refusé')!==false?'rgba(229,55,58,.08)':'rgba(0,198,122,.08)';?>;border:1px solid <?php echo strpos($success,'refusé')!==false?'rgba(229,55,58,.2)':'rgba(0,198,122,.2)';?>;border-radius:var(--r-xl);padding:2rem;text-align:center">
  <div style="font-size:2rem;margin-bottom:.75rem"><?php echo strpos($success,'refusé')!==false?'❌':'✅';?></div>
  <div style="font-family:'Sora',sans-serif;font-weight:800;font-size:1.1rem;color:var(--bnp-dark);margin-bottom:.5rem">Dossier soumis</div>
  <div style="font-size:.85rem;color:var(--gray600);margin-bottom:1.5rem"><?php echo $success;?></div>
  <div style="display:flex;gap:.5rem;justify-content:center"><a href="index.php" class="btn btn-primary">Mes crédits</a><a href="../index.php" class="btn btn-outline">Accueil</a></div>
</div>
<?php else:?>
<?php if($error):?><div style="background:rgba(229,55,58,.08);border:1px solid rgba(229,55,58,.2);border-radius:var(--r-md);padding:.85rem;margin-bottom:1.25rem;font-size:.82rem;color:var(--red)"><?php echo e($error);?></div><?php endif;?>
<div style="display:grid;grid-template-columns:1fr 280px;gap:1.5rem;align-items:start">
<div class="card card-pad">
  <form method="POST" id="creditForm">
    <input type="hidden" name="_csrf" value="<?php echo e($csrf);?>"/>
    <div class="form-group"><label class="form-label">Type de crédit</label>
    <select name="type" class="form-select" required onchange="updateRate(this.value)">
    ...
    <div style="height:1px;background:var(--gray100);margin:1rem 0"></div>
    <div class="form-group"><label class="form-label">Montant souhaité (€)</label><input class="form-input" name="montant" id="f_montant" type="number" min="1000" step="100" placeholder="25 000" required oninput="calcSim()"/></div>
    <div class="form-group"><label class="form-label">Durée : <b id="durLbl">60 mois</b></label>
      <input type="range" name="duree" id="f_duree" min="12" max="300" value="60" style="width:100%;margin-top:.5rem;accent-color:var(--bnp-emerald)" oninput="document.getElementById('durLbl').textContent=this.value+' mois';calcSim()"/>
    </div>
    <div style="background:rgba(212,175,55,.08);border:1px solid rgba(212,175,55,.2);border-radius:var(--r-lg);padding:1rem;margin-bottom:1.25rem">
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:.75rem;text-align:center">
        <div><div style="font-size:.62rem;color:var(--gray400);text-transform:uppercase;letter-spacing:.06em;margin-bottom:.3rem">Mensualité</div><div style="font-family:'Sora',sans-serif;font-weight:800;font-size:1.1rem;color:var(--bnp-dark)" id="simMens">—</div></div>
        <div><div style="font-size:.62rem;color:var(--gray400);text-transform:uppercase;letter-spacing:.06em;margin-bottom:.3rem">Taux TEG</div><div style="font-family:'Sora',sans-serif;font-weight:700;font-size:1rem;color:var(--bnp-emerald)" id="simTaux">—</div></div>
        <div><div style="font-size:.62rem;color:var(--gray400);text-transform:uppercase;letter-spacing:.06em;margin-bottom:.3rem">Coût total</div><div style="font-family:'Sora',sans-serif;font-weight:700;font-size:1rem;color:var(--gray800)" id="simTotal">—</div></div>
      </div>
    </div>
    <div style="height:1px;background:var(--gray100);margin:1rem 0"></div>
    <div class="form-row">
      <div class="form-group"><label class="form-label">Revenus nets mensuels (€)</label><input class="form-input" name="revenus" type="number" step="100" placeholder="3 000" required/></div>
      <div class="form-group"><label class="form-label">Charges mensuelles (€)</label><input class="form-input" name="charges" type="number" step="10" placeholder="800"/></div>
    </div>
    <div class="form-group"><label class="form-label">Situation professionnelle</label>
    <select name="situation" class="form-select"><option>CDI</option><option>CDD</option><option>Fonctionnaire</option><option>Indépendant</option><option>Retraité</option></select></div>
    <button type="submit" class="btn btn-primary" style="width:100%">Envoyer ma demande →</button>
  </form>
</div>
<div class="card card-pad">
  <div class="card-title" style="margin-bottom:1rem">Résumé de la demande</div>
  <div style="display:flex;flex-direction:column;gap:.5rem;font-size:.82rem">
    <?php foreach($rates_display as $type=>$rate):?>
    <div style="display:flex;justify-content:space-between;padding:.5rem 0;border-bottom:1px solid var(--gray50)"><span style="color:var(--gray400)"><?php echo ucfirst($type);?></span><span style="font-weight:600;color:var(--bnp-emerald)"><?php echo $rate;?></span></div>
    <?php endforeach;?>
  </div>
  <div style="margin-top:1.2rem;padding-top:1.2rem;border-top:1px solid var(--gray100);font-size:.78rem;color:var(--gray600);line-height:1.6">Réponse de principe sous 24h. Sous réserve d'acceptation de dossier.</div>
</div>
</div>
<?php endif;?>
...
<script>
const RATES={immobilier:1.9,auto:3.2,travaux:3.8,consommation:4.5};
let _rate=0;
function updateRate(t){_rate=RATES[t]||0;calcSim();}
function calcSim(){
  const amt=parseFloat(document.getElementById('f_montant')?.value)||0;
  const dur=parseInt(document.getElementById('f_duree')?.value)||60;
  if(!amt||!_rate){['simMens','simTaux','simTotal'].forEach(id=>{const e=document.getElementById(id);if(e)e.textContent='—';});return;}
  const r=_rate/100/12;
  const mens=r===0?amt/dur:amt*r*Math.pow(1+r,dur)/(Math.pow(1+r,dur)-1);
  document.getElementById('simMens').textContent=mens.toFixed(2)+' €';
  document.getElementById('simTaux').textContent=_rate+'%';
  document.getElementById('simTotal').textContent=Math.round(mens*dur).toLocaleString('fr-FR')+' €';
}
</script>
